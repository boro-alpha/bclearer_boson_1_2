...
def convert_to_attributes(
    ...
    log_message(
        message='adding ' + str(
            os_open_names.shape[0]) + ' in ' + os_open_names_table_name + ':' + attribute_name + ' to EA Attributes')
...
def __create_new_ea_attributes(
    ...
    new_ea_attributes[NfEaComColumnTypes.EXPLICIT_OBJECTS_EA_OBJECT_NAME.column_name] = \
        attribute_name
